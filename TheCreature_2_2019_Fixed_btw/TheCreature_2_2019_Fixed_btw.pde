//Dette skulle være løsningen på "Creature Walk", men der er meget galt!
//
...
//Opg 2 Ændrede alle ints til floats, da ints ikke kan være komma tal som det ville havde blevet nede ved zoomfaktoren.
//Opg 3 Lavede først en float for "ballwalk", dernæst proppede jeg ballwalk ind i "ballY", da sin har noget at gøre med y aksen
